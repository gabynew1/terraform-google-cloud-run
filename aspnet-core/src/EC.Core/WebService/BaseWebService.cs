...
namespace EC.WebService
{
    public abstract class BaseWebService
    {
        ...
        protected virtual async Task<string> PostAsyncSignserverProcess<T>(string baseAddress, string url, SignProcessDto input)
        {
            ...
            if (!_httpClient.BaseAddress.AbsoluteUri.Equals(baseAddress))
            {
